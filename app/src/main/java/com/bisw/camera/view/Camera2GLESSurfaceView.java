...
public class Camera2GLESSurfaceView extends BaseGLESCameraSurfaceView {
    ...
    public Camera2GLESSurfaceView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
